...
import (
	...
	webappv1 "github.com/yyt/builder-demo/api/v1"
)
...
// +kubebuilder:rbac:groups=webapp.ydzs.io,resources=books,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=webapp.ydzs.io,resources=books/status,verbs=get;update;patch
